...
VALUES
  ('email1', 'password1', 'username1', 'image_url1', 'first_name1', 'last_name1'),
  ('email2', 'password2', 'username2', 'image_url2', 'first_name2', 'last_name2'),
  ('email3', 'password3', 'username3', 'image_url3', 'first_name3', 'last_name3'),
  ('email4', 'password4', 'username4', 'image_url4', 'first_name4', 'last_name4'),
  ('email5', 'password5', 'username5', 'image_url5', 'first_name5', 'last_name5')
 ;
